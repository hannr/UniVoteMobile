...
public class ByteArrayToString
	...
	public String abstractConvert(ByteArray byteArray) {
		switch (this.radix) {
			...
			case BASE64:
				// DataTypeConverter does not work with Android. Using Base64 instead.
				//return DatatypeConverter.printBase64Binary(byteArray.getBytes());
				return Base64.encodeToString(byteArray.getBytes(), Base64.DEFAULT); 
			default:
				// impossible case
	...
	public ByteArray abstractReconvert(String string) {
		...
		switch (this.radix) {
			...
			case BASE64:
				...
				return ByteArray.getInstance(Base64.decode(string, Base64.DEFAULT));
